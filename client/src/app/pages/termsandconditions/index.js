...
const Termsandconditions = () => {
  return (
    <div className="terms-and-conditions">
      ...
      <p>Welcome to Mandala!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Mandala's Website, located at http://localhost:8081/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Mandala if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Mandala, you agreed to use
        cookies in agreement with the Mandala's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Mandala and/or its licensors own the
        intellectual property rights for all material on Mandala. All
        intellectual property rights are reserved. You may access this from
        Mandala for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Mandala</li>
        <li>Sell, rent or sub-license material from Mandala</li>
        <li>Reproduce, duplicate or copy material from Mandala</li>
        <li>Redistribute content from Mandala</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Mandala does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Mandala,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Mandala shall not be liable for the
      ...
      <p>
        Mandala reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Mandala a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Mandala; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Mandala. Please include your name, your organization name,
      ...
      <p>
        No use of Mandala's logo or other artwork will be allowed for linking
